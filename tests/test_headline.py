...
def test_headline_uses_bold_95_112():
    assert TEXT_SIZE_PX == 95
    assert TEXT_LINE_HEIGHT == 112
    assert TEXT_FONT_WEIGHT == 700
    assert default_font_path().name == "EurowingsWeb-Bold.ttf"
...
def test_default_position_is_bottom_left_with_padding():
